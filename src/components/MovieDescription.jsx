...
import { Rating, Button, Dialog, DialogContent } from '@mui/material';
...
const MovieDescription = () => {
    ...
    const baseUrl = "https://bookmyticket-v21x.onrender.com/movies/description"
...
<p style={{
  ...
  <DialogContent>
    ...
    <div>
      <p style={{backgroundColor: "rgba(40, 44, 52, 0.1)", color: "#282c34", padding: "8px"}}>TAMIL</p>
      <div className="options-row" onClick={(e) => handleLangFormat({language: "TAMIL", format: e.target.textContent})}>
        <Button variant="outlined" sx={{marginRight: "2px"}}>2D</Button>
        <Button variant="outlined" sx={{marginRight: "2px"}}>3D</Button>
